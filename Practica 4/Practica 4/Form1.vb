Public Class Form1
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ' en el formato de "dd 'de' MMMM 'del' yyyy" [dd- numero de dia, MMMM- el mes en el text, yyyy- para el año]
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles start.Click
